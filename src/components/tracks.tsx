    ...
    <div className="md:max-w-fit">
      {tracks.map((item: Record<string, unknown>, i) => {
        ...
        return (
          <div
            key={i}
            className="cursor-pointer grid border-t-2 border-l-2 border-r-2 border-white hover:border-green-500 rounded-md"
            onClick={() =>
            ...
            <div className="flex content-center items-center border-b-2 p-2 hover:border-green-500 hover:rounded-b-md">
              ...
              {/* </div> */}
              <div>
                <div className="text-left w-full whitespace-pre-wrap">{name}</div>
