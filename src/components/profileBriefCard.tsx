...
export default function ProfileBriefCard({
  ...
  return (
    <div className="cursor-pointer justify-around content-center flex flex-nowrap border-2 p-2 rounded-md shadow-sm hover:border-green-500">
      <div className="w-2/6 md:w-1/5 content-center flex flex-wrap justify-center">
        <div
      ...
      <div className="w-4/6 md:w-4/5 p-2 flex flex-wrap content-center">
