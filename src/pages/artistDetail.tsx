...
export default function ArtistDetail() {
  ...
  const t = [
    ...
    },
    {
      ...
      "popularity": 65,
      "preview_url": "https://p.scdn.co/mp3-preview/f6fdecfbaae1ed54bcfbae1bc2b088e8807c9783?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 5,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 63,
      "preview_url": "https://p.scdn.co/mp3-preview/a1a92ff710bfbff7e7768922c5616f4571e2cc97?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 4,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 62,
      "preview_url": "https://p.scdn.co/mp3-preview/607449ba733224db80be0c262f96034c9ed28ae7?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 13,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 69,
      "preview_url": "https://p.scdn.co/mp3-preview/047bd65c02b96672dc8cfed3e7f8ecf527bc7eba?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 2,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 64,
      "preview_url": "https://p.scdn.co/mp3-preview/09e878fa6a338f9afb5755fa04b0e63823f35fcd?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 4,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 64,
      "preview_url": "https://p.scdn.co/mp3-preview/9f0f42ee3e0dee6590c4aaf3e639edc765b1ae4a?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 2,
      "type": "track",
    ...
    },
    {
      ...
      "popularity": 62,
      "preview_url": "https://p.scdn.co/mp3-preview/c76bb593280d7c5bc29998707a545bf375682087?cid=774b29d4f13844c495f206cafdad9c86",
      "track_number": 3,
      "type": "track",
  ...
  return <div>
    <ArtistBriefCard title={name} imageUrl={imageUrl} subtitle={upperFirst(genreAggregate(genres))} />
    <div className="grid grid-cols-2 gap-2 my-2">
      <Link to={`${url}/top-tracks`} onClick={() => setKey(Math.random())}>
        <button className="w-full border-2 p-2 rounded-md">
          Top Tracks
      </button>
      </Link>
      ...
      <div className="col-span-2">
        <Switch>
          <Route path={`${path}/top-tracks`} render={() => <Tracks tracks={t} />} />
          <Route path={`${path}/related-artists`} render={() => <Artists artists={a} />} />
        </Switch>
      </div>
    </div>
  </div>
